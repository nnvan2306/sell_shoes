    ...
    const onSubmit = async (dt) => {
        ...
        try {
            const { data } = await axios.put(
                `${baseUrl}/api/vouchers/updateVoucher/${item.id}`,
                formData,
                config
            );
            setVoucherList((prev) => {
    ...
    return (
        ...
        >
            ...
            <div style={{ display: "flex" }}>
                <div
                    style={{ display: "flex", alignItems: "end", width: "50%" }}
                >
                ...
                >
                    <div className={cx("input-field-left")}>
                        <label className={cx("label-input")}>
                            Áp dụng cho{" "}
                            <HiOutlineInformationCircle fontSize={"18px"} />{" "}
                        </label>
                        <Select
                            options={cbb}
                            defaultValue={
            ...
            {err && (
                <div className={cx("error")} style={{ marginLeft: "40px" }}>
                    {err}
                </div>
            )}
            <form
                onSubmit={handleSubmit(onSubmit)}
                style={{ padding: "2rem 4rem 2.5rem 4rem", width: "100%" }}
            >
                        ...
                        <div className={cx("input-field-left")}>
                            ...
                            <input
                                ...
                                {...register("voucherCode", {
                                    required: "Mã giảm giá chưa được nhập!",
                                })}
                                id="voucherCode"
                                type="text"
                                placeholder="WOMENDAY21T"
                                className={cx("input")}
                            />
                        </div>
                        {errors.voucherCode && (
                    ...
                    >
                        <div className={cx("input-field-right")}>
                            ...
                            <input
                                ...
                                {...register("quanlity", {
                                    required: "Số lượng chưa được nhập!",
                                    valueAsNumber: {
                                        value: true,
                    ...
                    >
                        <div className={cx("input-field-left")}>
                            ...
                            <input
                                ...
                                name="priceDiscount"
                                aria-invalid={
                                    errors.priceDiscount ? "true" : "false"
                                }
                                style={
                                ...
                                {...register("priceDiscount", {
                                    required: "Giá giảm chưa được nhập!",
                                    valueAsNumber: {
                                        value: true,
                                        message: "Giá giảm phải là một số",
                                    },
                                    min: {
                                        value: 0,
                                        message: "Giá giảm không được âm",
                                    },
                                })}
                                id="priceDiscount"
                                type="number"
                                placeholder={isPc ? "10 (%)" : "50.000 (VND)"}
                                className={cx("input")}
                            />
                        </div>
                        {errors.priceDiscount && (
                    ...
                    >
                        <div className={cx("input-field-right")}>
                            ...
                            <input
                                ...
                                {...register("minPrice", {
                                    required:
                                        "Giá trị tối thiểu chưa được nhập!",
                                    valueAsNumber: {
                                        value: true,
                                        message:
                                            "Giá trị tối thiểu phải là một số",
                                    },
                                    min: {
                                        value: 0,
                                        message:
                ...
                <div className={cx("row-input")}>
                    ...
                    >
                        <div className={cx("input-field-left")}>
                            ...
                            <input
                                defaultValue={item.startDate.split("T")[0]}
                                name="startDate"
                                aria-invalid={
                                ...
                                {...register("startDate", {
                                    required: "Ngày bắt đầu chưa được nhập!",
                                })}
                                type="date"
                                className={cx("input")}
                            />
                    ...
                    >
                        <div className={cx("input-field-right")}>
                            ...
                            <input
                                defaultValue={item.expiredDate.split("T")[0]}
                                name="endDate"
                                ...
                                {...register("endDate", {
                                    required: "Ngày kết thúc chưa được nhập!",
                                })}
                                id="endDate"
                                type="date"
                                className={cx("input")}
                ...
                <div>
                    ...
                    >
                        ...
                        <textarea
                            ...
                            id="description"
                            type="text"
                            placeholder="Sale ngày phụ nữ việt nam. Áp dụng để giảm tiền trực tiếp cho đơn hàng!"
                            style={{
                                marginTop: "12px",
