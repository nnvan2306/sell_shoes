        ...
        <div className={cx("wrapper")} style={{ fontSize: "14px" }}>
            <div className={cx("container")}>
                ...
                <div className={cx("content")}>
                            ...
                            <tbody className={cx("tbody")}>
                                {voucherList
                                    ...
                                    .filter((item) => {
                                        ...
                                        if (selectedFilter === "UnExpired")
                                            return !checkStatus(item);
                                        return true;
                                    })
                                    .filter((i) => {
                                        if (selectedTextFilter.length === 0)
                                            return true;
                                        else
                                            return i.voucherCode
                                                .toLowerCase()
                                                .includes(
                                                    selectedTextFilter.toLowerCase()
                                                );
                                    })
                                    .map((item, index) => {
                                        return (
                    ...
                    >
                        <div>
                            Showing: <span>{recordPerPages}</span> of{" "}
                            {voucherList.length} entries
                        </div>
                        <nav>
