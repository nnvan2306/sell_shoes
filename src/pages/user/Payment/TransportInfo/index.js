        ...
        <div className={cx("outer")}>
            ...
            >
                <div style={{ width: "50%" }}>
                    ...
                    />
                    {!firstLoad && error.name && !selected.name && (
                        <span
                            style={{
                                display: "flex",
                                flexDirection: "row",
            ...
            <div>
                ...
                />
                {!firstLoad && error.email && !selected.email && (
                    <span
                        style={{
                            display: "flex",
                            flexDirection: "row",
            ...
            <div>
                ...
                />
                {!firstLoad && error.detail && !selected.detail && (
                    <span
                        style={{
                            display: "flex",
                            flexDirection: "row",
            ...
            <div className={cx("outer-address")}>
                <div className={cx("addressItem")}>
                    <ComboBox
                        ...
                        selectedItem={selected.province}
                        type={"list"}
                        filterValueSelected={filterProvince}
                    />
                    {!firstLoad && error.province && !selected.province && (
                        <span
                            style={{
                                display: "flex",
                                flexDirection: "row",
                ...
                <div className={cx("addressItem")}>
                    <ComboBox
                        ...
                        selectedItem={selected.district}
                        type={"list"}
                        filterValueSelected={filterDistrict}
                    />
                    {!firstLoad && error.district && !selected.district && (
                        <span
                            style={{
                                display: "flex",
                                flexDirection: "row",
                ...
                <div className={cx("addressItem")}>
                    <ComboBox
                        ...
                        selectedItem={selected.ward}
                        type={"list"}
                        filterValueSelected={(e) => {
                            setSelected({ ...selected, ward: e.name });
                        }}
                    />
                    {!firstLoad && error.ward && !selected.ward && (
                        <span
                            style={{
                                display: "flex",
                                flexDirection: "row",
