...
import {
    decreaseQuantityCartItemNonUser,
    deleteCartItemNonUser,
                ...
                <div className={cx("rightContent")}>
                    <div>
                        <div className={cx("outerContent")}>
                            ...
                            <span
                                className={cx("colorSize")}
                            >{`${defaultSelection.colorName} / ${defaultSelection.size}`}</span>
                        </div>
                        <div className={cx("selector")}>
                            <div style={{ width: "120px" }}>
                                <ComboBox
                                    listItems={colors}
                                    placeHolder={""}
                                    selectedItem={props.color}
                                    type={"list-gray"}
                                    filterValueSelected={onColorchange}
                                />
                            </div>
                            <div style={{ width: "120px" }}>
                                <ComboBox
